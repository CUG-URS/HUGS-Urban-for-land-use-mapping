...
hist_spec2='E:\experiment\pd\spe\spestr_393\ucm_msd_H_1000.mat';
% hist_spec2='E:\experiment\pd\sift\siftstr_393\ucm_msd_H_1000.mat';
% hist_spec2='E:\experiment\pd\result\speori_siftori_ocr.mat';
load('E:\experiment\pd\pd_patch.mat');

%hist_spec2='E:\experiment\pd\result\spe393_sift393_ocr.mat';
hist_spec2 = load(hist_spec2);
hist_spec2=cell2mat(struct2cell(hist_spec2));

y=xlsread('E:\experiment\pd\pd_label.xlsx','Sheet1','d2:d625');
x=xlsread('E:\experiment\pd\pd_label.xlsx','Sheet1','a2:a625');
area=xlsread('E:\experiment\pd\pd_label.xlsx','Sheet1','b2:b625');
...
%                 path='E:\experiment\pd\fstm\speori_siftori_ocr-0.8';
...
%                 为测试数据附上真实类别编号
         ...
         A=[D3,test_result',D(:,b-1)];
           ...
           for x=1:row
               index=A(x,2);
                if(patchnums(index)<=patchnums(393))
                    weakall=weakall+1;
                   if(A(x,1)==A(x,3))
                      weak=weak+1;
                   end
